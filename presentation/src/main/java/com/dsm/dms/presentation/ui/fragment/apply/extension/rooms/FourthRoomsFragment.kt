...
class FourthRoomsFragment(val vm: ApplyExtensionFloorDetailViewModel): Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View = inflater.inflate(R.layout.fragment_apply_extension_fourth_floor_rooms, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        extension_fourth_floor_first_room_card.onClick {
            vm.changeRoom("학교측")
        }
        extension_fourth_floor_second_room_card.onClick {
            vm.changeRoom("기숙사측")
        }
    ...
    private fun changeRoom(room: String, isNew: Boolean) {
        ...
        when(room) {
            "학교측" -> {
                cardView = extension_fourth_floor_first_room_card
                textView = extension_fourth_floor_first_room_tv
            }
            "기숙사측" -> {
                cardView = extension_fourth_floor_second_room_card
                textView = extension_fourth_floor_second_room_tv
            }
        }
