...
class SecondRoomsFragment(val vm: ApplyExtensionFloorDetailViewModel): Fragment() {

    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View = inflater.inflate(R.layout.fragment_apply_extension_second_floor_rooms, container, false)
    ...
    private fun changeRoom(room: String, isNew: Boolean) {
        ...
        when(room) {
            "자습실" -> {
                cardView = extension_second_floor_first_room_card
                textView = extension_second_floor_first_room_tv
            }
        }
